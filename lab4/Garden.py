...
class Garden:
    ...
    def daily_update(self, season, temperature, air_moisture, rain_mm):
        ...
        for i in range(len(self.plants)):
            ...
            self.soil_wetness[i] -= delta[i, 0]/(self.soil_area[i]*1500) # 1m^3 грунту може утримувати 150-600 літрів води, вважатимемо що глибина грунту -- 5 метрів
        soil_wetness_evaporation_delta = max(temperature*0.001, 0.0001)*(1+self.soil_wetness_history[-1])**3
